...
For a latest tag `v0.1.17`, this creates release version `v0.1.18` and image `10.159.21.58:5000/agentlab:0.1.18` when the current deployed image repository is `10.159.21.58:5000/agentlab`.
...
New version:     v0.1.18
Current image:   10.159.21.58:5000/agentlab:0.1.17
New image:       10.159.21.58:5000/agentlab:0.1.18
```
...
agentlab release upgrade \
  --version 0.1.18 \
  --image-repository 10.159.21.58:5000/agentlab \
  --dry-run
```
...
```bash
agentlab release upgrade \
  --image 10.159.21.58:5000/agentlab:0.1.18 \
  --apply \
  --preserve-cluster-config
```
...
agentlab release upgrade \
  --bump-patch \
  --bootstrap-k8s \
  --gitlab-url https://gitlab.int.mein-libra.de/ \
  --project-id 5 \
  --target-repo-url https://gitlab.int.mein-libra.de/ref43/ZFS-Manager.git \
  --target-repo-ref main \
  --ollama-url http://10.159.21.48:11434 \
  --model qwen3.6:35b \
  --git-author-name "AgentLab Bot" \
  --git-author-email "agentlab-bot@gitlab.int.mein-libra.de"
```
